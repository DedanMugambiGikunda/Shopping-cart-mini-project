...
<body>
    ...
    <div class="Router">
            <div class="column">
                    <img src="./images/images.png" alt="Router" sizes="" srcset=""></img>
                        <figcaption>safaricom NetGear</figcaption>
            ...
            <div class="column">
                    <img src="./images/images (14).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Zuku Chrome</figcaption>
            ...
            <div class="column">
                    <img src="./images/images (19).jfif" alt="Router" sizes="" srcset=""></img>
                        ...
                        <figcaption><strong>Ksh.3,900</strong></figcaption>
                        <figcaption>20 users max</figcaption>
                        <figcaption>1,000 Mbps</figcaption>
                        <figure class="caption">10 units left!</figure>
                        <figcaption><button>Add to Cart</button><a href="tel:254703618170" onclick="ga('send', 'event', { eventCategory: 'Contact', eventAction: 'Call', eventLabel: 'Mobile Button'});"><span title="call the saler"><button class="call">CALL</button></span></a></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (21).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Fiber Wi-fi6</figcaption>
                        <figcaption><strong>Ksh.5,400</strong></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (16).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Safaricom Fast</figcaption>
                        <figcaption><strong>Ksh.5,500</strong></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (20).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Classic Wifi</figcaption>
                        <figcaption><strong>Ksh.5,800</strong></figcaption>
                        <figcaption>50 users max</figcaption>
                        <figcaption>1,000 Mbps</figcaption>
            ...
            <div class="column">
                    <img src="./images/images (15).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Home Wifi</figcaption>
                        <figcaption><strong>Ksh.3,200</strong></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (22).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Motorola modem</figcaption>
                        <figcaption><strong>Ksh.2,500</strong></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (13).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>U-trendy wifi</figcaption>
                        <figcaption><strong>Ksh.4,800</strong></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (17).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>DSTV white</figcaption>
                        <figcaption><strong>Ksh.3,700</strong></figcaption>
                        <figcaption>20 users max</figcaption>
                        <figcaption>1,000 Mbps</figcaption>
                        <figure class="caption">10 units left!</figure>
            ...
            <div class="column">
                    <img src="./images/download (19).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Zuku Pro</figcaption>
                        <figcaption><strong>Ksh.3,700</strong></figcaption>
            ...
            <div class="column">
                    <img src="./images/images (18).jfif" alt="Router" sizes="" srcset=""></img>
                        <figcaption>Gotv NetGear</figcaption>
